...
349:                                              ; preds = %300, %349
  ...
  store double 2.000000e-02, double* %352, align 8, !tbaa !8
  %353 = add nuw nsw i64 %350, 1
  %354 = icmp eq i64 %353, %270
  br i1 %354, label %346, label %349, !llvm.loop !24
...
420:                                              ; preds = %419, %420
  ...
  br i1 %448, label %449, label %420, !llvm.loop !26
...
451:                                              ; preds = %449, %451
  ...
  br i1 %461, label %462, label %451, !llvm.loop !27
...
466:                                              ; preds = %417, %466
  ...
  store double 3.000000e-02, double* %469, align 8, !tbaa !8
  %470 = add nuw nsw i64 %467, 1
  %471 = icmp eq i64 %470, %387
  br i1 %471, label %463, label %466, !llvm.loop !28
...
537:                                              ; preds = %536, %537
  ...
  br i1 %565, label %566, label %537, !llvm.loop !29
...
568:                                              ; preds = %566, %568
  ...
  br i1 %578, label %579, label %568, !llvm.loop !30
...
583:                                              ; preds = %534, %583
  ...
  store double 4.000000e-02, double* %586, align 8, !tbaa !8
  %587 = add nuw nsw i64 %584, 1
  %588 = icmp eq i64 %587, %504
  br i1 %588, label %580, label %583, !llvm.loop !31
...
649:                                              ; preds = %649, %647
  ...
  store <2 x double> <double 6.000000e-02, double 6.000000e-02>, <2 x double>* %654, align 8, !tbaa !8, !alias.scope !32, !noalias !35
  %655 = getelementptr inbounds double, double* %653, i64 2
  %656 = bitcast double* %655 to <2 x double>*
  store <2 x double> <double 6.000000e-02, double 6.000000e-02>, <2 x double>* %656, align 8, !tbaa !8, !alias.scope !32, !noalias !35
  %657 = getelementptr inbounds double, double* %609, i64 %652
  %658 = bitcast double* %657 to <2 x double>*
  store <2 x double> <double 7.000000e-02, double 7.000000e-02>, <2 x double>* %658, align 8, !tbaa !8, !alias.scope !38, !noalias !39
  %659 = getelementptr inbounds double, double* %657, i64 2
  %660 = bitcast double* %659 to <2 x double>*
  store <2 x double> <double 7.000000e-02, double 7.000000e-02>, <2 x double>* %660, align 8, !tbaa !8, !alias.scope !38, !noalias !39
  %661 = getelementptr inbounds double, double* %610, i64 %652
  %662 = bitcast double* %661 to <2 x double>*
  store <2 x double> <double 8.000000e-02, double 8.000000e-02>, <2 x double>* %662, align 8, !tbaa !8, !alias.scope !39
  %663 = getelementptr inbounds double, double* %661, i64 2
  %664 = bitcast double* %663 to <2 x double>*
  store <2 x double> <double 8.000000e-02, double 8.000000e-02>, <2 x double>* %664, align 8, !tbaa !8, !alias.scope !39
  %665 = or i64 %650, 4
  %666 = add i64 %665, %611
  %667 = getelementptr inbounds double, double* %608, i64 %666
  %668 = bitcast double* %667 to <2 x double>*
  store <2 x double> <double 6.000000e-02, double 6.000000e-02>, <2 x double>* %668, align 8, !tbaa !8, !alias.scope !32, !noalias !35
  %669 = getelementptr inbounds double, double* %667, i64 2
  %670 = bitcast double* %669 to <2 x double>*
  store <2 x double> <double 6.000000e-02, double 6.000000e-02>, <2 x double>* %670, align 8, !tbaa !8, !alias.scope !32, !noalias !35
  %671 = getelementptr inbounds double, double* %609, i64 %666
  %672 = bitcast double* %671 to <2 x double>*
  store <2 x double> <double 7.000000e-02, double 7.000000e-02>, <2 x double>* %672, align 8, !tbaa !8, !alias.scope !38, !noalias !39
  %673 = getelementptr inbounds double, double* %671, i64 2
  %674 = bitcast double* %673 to <2 x double>*
  store <2 x double> <double 7.000000e-02, double 7.000000e-02>, <2 x double>* %674, align 8, !tbaa !8, !alias.scope !38, !noalias !39
  %675 = getelementptr inbounds double, double* %610, i64 %666
  %676 = bitcast double* %675 to <2 x double>*
  store <2 x double> <double 8.000000e-02, double 8.000000e-02>, <2 x double>* %676, align 8, !tbaa !8, !alias.scope !39
  %677 = getelementptr inbounds double, double* %675, i64 2
  %678 = bitcast double* %677 to <2 x double>*
  store <2 x double> <double 8.000000e-02, double 8.000000e-02>, <2 x double>* %678, align 8, !tbaa !8, !alias.scope !39
  %679 = add i64 %650, 8
  %680 = add i64 %651, -2
  %681 = icmp eq i64 %680, 0
  br i1 %681, label %682, label %649, !llvm.loop !40
...
685:                                              ; preds = %682
  ...
  store <2 x double> <double 6.000000e-02, double 6.000000e-02>, <2 x double>* %688, align 8, !tbaa !8, !alias.scope !32, !noalias !35
  %689 = getelementptr inbounds double, double* %687, i64 2
  %690 = bitcast double* %689 to <2 x double>*
  store <2 x double> <double 6.000000e-02, double 6.000000e-02>, <2 x double>* %690, align 8, !tbaa !8, !alias.scope !32, !noalias !35
  %691 = getelementptr inbounds double, double* %609, i64 %686
  %692 = bitcast double* %691 to <2 x double>*
  store <2 x double> <double 7.000000e-02, double 7.000000e-02>, <2 x double>* %692, align 8, !tbaa !8, !alias.scope !38, !noalias !39
  %693 = getelementptr inbounds double, double* %691, i64 2
  %694 = bitcast double* %693 to <2 x double>*
  store <2 x double> <double 7.000000e-02, double 7.000000e-02>, <2 x double>* %694, align 8, !tbaa !8, !alias.scope !38, !noalias !39
  %695 = getelementptr inbounds double, double* %610, i64 %686
  %696 = bitcast double* %695 to <2 x double>*
  store <2 x double> <double 8.000000e-02, double 8.000000e-02>, <2 x double>* %696, align 8, !tbaa !8, !alias.scope !39
  %697 = getelementptr inbounds double, double* %695, i64 2
  %698 = bitcast double* %697 to <2 x double>*
  store <2 x double> <double 8.000000e-02, double 8.000000e-02>, <2 x double>* %698, align 8, !tbaa !8, !alias.scope !39
  br label %699
...
703:                                              ; preds = %701, %703
  ...
  br i1 %709, label %703, label %710, !llvm.loop !41
...
760:                                              ; preds = %758, %760
  ...
  br i1 %771, label %772, label %760, !llvm.loop !42
...
declare !callback !43 dso_local void @__kmpc_fork_call(%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) local_unnamed_addr
...
69:                                               ; preds = %68, %69
  ...
  %96 = add i64 %71, -2
  %97 = icmp eq i64 %96, 0
  br i1 %97, label %98, label %69, !llvm.loop !45
...
121:                                              ; preds = %121, %113
  ...
  store double %147, double* %153, align 8, !tbaa !8, !nontemporal !46
...
!22 = distinct !{!22, !19}
!23 = distinct !{!23, !11}
!24 = distinct !{!24, !25, !19}
!25 = !{!"llvm.loop.unroll.runtime.disable"}
!26 = distinct !{!26, !19}
!27 = distinct !{!27, !11}
!28 = distinct !{!28, !25, !19}
!29 = distinct !{!29, !19}
!30 = distinct !{!30, !11}
!31 = distinct !{!31, !25, !19}
!32 = !{!33}
!33 = distinct !{!33, !34}
