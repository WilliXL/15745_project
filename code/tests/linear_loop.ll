...
2:                                                ; preds = %2, %1
  %3 = phi i64 [ 0, %1 ], [ %10, %2 ]
  %4 = phi <4 x i32> [ <i32 0, i32 1, i32 2, i32 3>, %1 ], [ %11, %2 ]
  %5 = phi <4 x i32> [ <i32 0, i32 1, i32 2, i32 3>, %1 ], [ %12, %2 ]
  %6 = mul nsw <4 x i32> %4, %4
  %7 = sub nsw <4 x i32> %6, %5
  %8 = getelementptr inbounds i32, i32* %0, i64 %3
  %9 = bitcast i32* %8 to <4 x i32>*
  store <4 x i32> %7, <4 x i32>* %9, align 4, !tbaa !2
  %10 = add i64 %3, 4
  %11 = add <4 x i32> %4, <i32 4, i32 4, i32 4, i32 4>
  %12 = add <4 x i32> %5, <i32 4, i32 4, i32 4, i32 4>
  %13 = icmp eq i64 %10, 8192
...
16:                                               ; preds = %16, %0
  ...
  %19 = call noalias i8* @malloc(i64 32768) #7
